...
void
initPathAttr(pathattr * pattr, g2sattr * attr);
void
setEdge(parsedata * pdata, double _x, double _y, double _z,
        double length, double interval, double speed);
void
setPathInterval(parsedata * pdata);
void
setPathData(pathattr * pattr, g2sattr * attr);
void
countUnconverted(parsedata * pdata);
void
countPath(parsedata * pdata);
int
checkPath(parsedata * pdata);
void
setPath( parsedata * pdata);
