	...
	public void handleMessage(Message msg)
	{
		...
		case MSG_MAP_DOWNLOAD_FINISHED : {
			...
			if (msg.getData().getInt("value1") == 1) {
				...
				double lon=(Double.parseDouble(NavitMapDownloader.osm_maps[mi].lon1)+Double.parseDouble(
				                    NavitMapDownloader.osm_maps[mi].lon2))/2.0;
				double lat=(Double.parseDouble(NavitMapDownloader.osm_maps[mi].lat1)+Double.parseDouble(
				                    NavitMapDownloader.osm_maps[mi].lat2))/2.0;
