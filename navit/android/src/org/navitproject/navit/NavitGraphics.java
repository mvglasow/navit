		...
		if (this.parent_graphics != null)
			...
			if (Build.VERSION.SDK_INT >= 17) {
				...
				if (activity instanceof Navit) {
					...
					Log.d("NavitGraphics", String.format("frameLayout: width=%d height=%d",
					...
					frameLayout.post(new Runnable() {
						...
						public void run() {
							...
							Log.d("NavitGraphics", String.format("navigationLayoutParams: x=%d y=%d gravity=%s (guessed)",
									navigationLayoutParams.width, navigationLayoutParams.height, "BOTTOM | RIGHT"));
